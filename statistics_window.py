...
class Statistics:
    ...
    def __init__(self, window, sim):
        ...
        self.stat7label = tk.Label(self.window, text="Average vel: "         + str(va.avg_vel),               font=label_font, borderwidth=1, relief=tk.SOLID)
        self.stat8label = tk.Label(self.window, text="Average speed: "       + str(va.avg_vel_mag),           font=label_font, borderwidth=1, relief=tk.SOLID)
    ...
    def update(self):
        ...
        self.stat7label['text'] = "Average vel: "         + str(va.avg_vel)
        self.stat8label['text'] = "Average speed: "       + str(va.avg_vel_mag)